...
export const BASIC_STYLE = {
  ...
  "sources": {
    "openmaptiles": {
      "type": "vector",
      "url": `https://api.maptiler.com/tiles/v3/tiles.json?key=aoPEljV30TjtHVhWpE5O`
    },
    "landcover": {
      "type": "vector",
      "url": `https://api.maptiler.com/tiles/landcover/tiles.json?key=aoPEljV30TjtHVhWpE5O`
    },
  ...
  "glyphs": `https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=aoPEljV30TjtHVhWpE5O`,
  "layers": [
    {
      "id": "background",
      "type": "background",
